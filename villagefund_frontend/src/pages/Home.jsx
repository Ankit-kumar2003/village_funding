...
export default function Home() {
  ...
  return (
    <div className="w-full">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-6 md:space-y-8">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold font-heading tracking-tight leading-tight">
              {t('heroTitle')} <span className="text-secondary-light block mt-2 text-green-300">{t('heroTitleHighlight')}</span>
            </h1>
      ...
      {/* Quick Stats Section */}
      <section className="py-8 md:py-12 bg-background relative z-20">
        <div className="container mx-auto px-4">
          <div className="bg-surface rounded-2xl shadow-xl border border-border p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center max-w-5xl mx-auto md:-mt-24 relative z-10">
            <div>
            ...
            <div className="md:hidden h-px bg-border w-full mx-auto"></div>
            <div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-text mb-2">{t('activeCampaigns')}</h2>
              <p className="text-text-muted">{t('campaignsSubtitle')}</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-surface rounded-xl shadow-sm border border-border">
              <h3 className="text-xl text-text-muted">{t('noCampaigns')}</h3>
            </div>
          ) : (
      ...
      <section className="py-20 bg-surface border-t border-border">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-text mb-4">{t('howItWorksTitle')}</h2>
            <p className="text-text-muted text-lg">{t('howItWorksSubtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold font-heading text-text">{t('step1Title')}</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold font-heading text-text">{t('step2Title')}</h3>
              <p className="text-text-muted leading-relaxed">
                {t('step2Desc')}
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold font-heading text-text">{t('step3Title')}</h3>
              <p className="text-text-muted leading-relaxed">
                {t('step3Desc')}
              </p>
            </div>
      ...
      <section className="py-20 bg-secondary text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold font-heading mb-6">{t('ctaTitle')}</h2>
